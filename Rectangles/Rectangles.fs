...
module Main = 
    ...
    let drawRectangle (Rect ((Vector (x0, y0)), (Vector (x1, y1)))) (gd:GraphicsDevice) = 
        ...
        vertex.[0].Position <- Vector3(float32 x0, float32 y0, 0.f)
        vertex.[1].Position <- Vector3(float32 x0, float32 y1, 0.f)
        vertex.[2].Position <- Vector3(float32 x1, float32 y1, 0.f)
        vertex.[3].Position <- Vector3(float32 x1, float32 y0, 0.f)
        vertex.[4].Position <- Vector3(float32 x0, float32 y0, 0.f)
